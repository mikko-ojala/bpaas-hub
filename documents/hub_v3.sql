...
CREATE  TABLE IF NOT EXISTS `bpaashub`.`organisation_users` (
  ...
  `reserved1` TINYINT(4) NOT NULL ,
  `reserved2` TINYINT(4) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `bpaashub`.`users_has_users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bpaashub`.`users_has_users` ;

CREATE  TABLE IF NOT EXISTS `bpaashub`.`users_has_users` (
  `users_id` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `bpaashub`.`service_has_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bpaashub`.`service_has_service` ;

CREATE  TABLE IF NOT EXISTS `bpaashub`.`service_has_service` (
  `service_id` INT(11) NOT NULL ,
  `service_id1` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `bpaashub`.`organisation_has_organisation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bpaashub`.`organisation_has_organisation` ;

CREATE  TABLE IF NOT EXISTS `bpaashub`.`organisation_has_organisation` (
  `organisation_id` INT(11) NOT NULL ,
  `organisation_id1` INT(11) NOT NULL ,
  PRIMARY KEY (`organisation_id`, `organisation_id1`) ,
  INDEX `fk_organisation_has_organisation_organisation2_idx` (`organisation_id1` ASC) ,
  INDEX `fk_organisation_has_organisation_organisation1_idx` (`organisation_id` ASC) ,
  CONSTRAINT `fk_organisation_has_organisation_organisation1`
    FOREIGN KEY (`organisation_id` )
    REFERENCES `bpaashub`.`organisation` (`id` )
    ON DELETE CASCADE
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_organisation_has_organisation_organisation2`
    FOREIGN KEY (`organisation_id1` )
    REFERENCES `bpaashub`.`organisation` (`id` )
    ON DELETE CASCADE
    ON UPDATE RESTRICT)
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `bpaashub`.`organisation_image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bpaashub`.`organisation_image` ;

CREATE  TABLE IF NOT EXISTS `bpaashub`.`organisation_image` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `image_type` VARCHAR(25) NOT NULL ,
  `image` BLOB NOT NULL ,
  `image_size` VARCHAR(25) NOT NULL ,
  `image_ctgy` VARCHAR(25) NOT NULL ,
  `imagecol` VARCHAR(50) NULL ,
  `organisation_id` INT(11) NOT NULL ,
  PRIMARY KEY (`id`, `organisation_id`) ,
  INDEX `fk_organisation_image_organisation1_idx` (`organisation_id` ASC) ,
  CONSTRAINT `fk_organisation_image_organisation1`
    FOREIGN KEY (`organisation_id` )
    REFERENCES `bpaashub`.`organisation` (`id` )
    ON DELETE CASCADE
    ON UPDATE RESTRICT)
...
-- -----------------------------------------------------
-- Table `bpaashub`.`service_image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bpaashub`.`service_image` ;

CREATE  TABLE IF NOT EXISTS `bpaashub`.`service_image` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `image_type` VARCHAR(25) NOT NULL ,
  `image` BLOB NOT NULL ,
  `image_size` VARCHAR(25) NOT NULL ,
  ...
  INDEX `fk_service_image_service1_idx` (`service_id` ASC) ,
  CONSTRAINT `fk_service_image_service1`
    FOREIGN KEY (`service_id` )
    REFERENCES `bpaashub`.`service` (`id` )
    ON DELETE CASCADE
    ON UPDATE RESTRICT)
...
-- -----------------------------------------------------
-- Table `bpaashub`.`user_image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bpaashub`.`user_image` ;

CREATE  TABLE IF NOT EXISTS `bpaashub`.`user_image` (
  `id` INT NOT NULL AUTO_INCREMENT ,
  `image_type` VARCHAR(25) NOT NULL ,
  `image` BLOB NOT NULL ,
  `image_size` VARCHAR(25) NOT NULL ,
  `image_ctgy` VARCHAR(25) NOT NULL ,
  `imagecol` VARCHAR(50) NULL ,
  `profiles_user_id` INT(11) NOT NULL ,
  PRIMARY KEY (`id`, `profiles_user_id`) ,
  INDEX `fk_user_image_profiles1_idx` (`profiles_user_id` ASC) ,
  CONSTRAINT `fk_user_image_profiles1`
    FOREIGN KEY (`profiles_user_id` )
    REFERENCES `bpaashub`.`profiles` (`user_id` )
    ON DELETE CASCADE
    ON UPDATE RESTRICT)
ENGINE = InnoDB;
